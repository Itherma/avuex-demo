    ...
    bind (el, binding, vnode, oldVnode) {
      ...
      dialogHeaderEl.onmousedown = (e) => {
        ...
        document.onmousemove = function (e) {
          ...
          if (finallyT < 0) {
            finallyT = 0
          } else if (finallyT > (dragDom.offsetParent.clientHeight || +document.body.clientHeight) - dragDom.clientHeight - dragDom.offsetParent.offsetLeft) {
            (finallyT = (dragDom.offsetParent.clientHeight || +document.body.clientHeight) - dragDom.clientHeight - dragDom.offsetParent.offsetLeft)
          }

          // 防止标题栏卡出屏幕
          if (finallyL < 0) finallyL = 0
          if (finallyT < 0) finallyT = 0
